 ...
 * Navigation sidebar for Dashboard, Agents, and Plugins pages
 */
class Sidebar {
      ...
      <nav class="sidebar ${this.isCollapsed ? 'collapsed' : ''}">
        ...
        <div class="sidebar-content">
          <ul class="nav-menu">
            ...
            <li class="nav-item ${this.currentPage === 'agents' ? 'active' : ''}" data-page="agents" title="Conversations & Agents">
              <a href="#" class="nav-link">
                <div class="nav-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <li class="nav-item ${this.currentPage === 'plugins' ? 'active' : ''}" data-page="plugins" title="Plugins & MCPs">
              <a href="#" class="nav-link">
                <div class="nav-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
